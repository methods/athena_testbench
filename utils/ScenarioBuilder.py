...
class ScenarioBuilder:
    ...
    def reset_nhs_data(self):
        self.create_nhs_table()
        self.con.run('DELETE FROM "nhs_clean_staging"')
        self.con.commit()
    ...
    def reset_ivr_data(self):
        self.create_ivr_table()
        self.con.run('DELETE FROM "ivr_clean_staging"')
        self.con.commit()
    ...
    def reset_web_data(self):
        self.create_web_table()
        self.con.run('DELETE FROM "web_clean_staging"')
        self.con.commit()
    ...
    def reset_la_feedback_data(self):
        self.create_la_feedback_table()
        self.con.run('DELETE FROM "raw_la_outcomes_staging"')
        self.con.commit()
